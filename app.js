...
// ============================================================
const MAPS_EMBED_KEY = 'AIzaSyBLK2dWb9prXg2Hyd97I8F8YcJqw2mof5A';
...
const CATEGORIES = {
  'Transportation':   ['Train', 'Airplane', 'Highway', 'Boat', 'Railroad', 'Ferry', 'Bicycle', 'Canal'],
...
function renderReveal(r) {
  ...
  if (myRole === 'imposter') {
    ...
    $('reveal-instruction').textContent =
      "You don't know the exact word — but you know the category. Drop a pin somewhere that fits the theme and bluff convincingly.";
  } else {
